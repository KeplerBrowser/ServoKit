...
/** Small loopback HTTP server for the shared cross-host smoke fixtures. */
object ExampleFixtureServer {
  ...
  fun start(context: Context) {
    ...
    synchronized(this) {
      ...
      thread(name = "ServokitNativeFixtureServer", isDaemon = true) {
        try {
          while (!serverSocket.isClosed) {
            ...
            thread(name = "ServokitNativeFixtureRequest", isDaemon = true) {
